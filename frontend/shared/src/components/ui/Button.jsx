...
const Button = ({ variant = 'primary', size = 'md', disabled, isLoading, onClick, type = 'button', children, className = '' }) => {
  ...
  const variantClasses = {
    primary: 'bg-gradient-to-r from-primary-500 to-primary-600 hover:from-primary-600 hover:to-primary-700 text-white shadow-lg shadow-primary-500/30 hover:shadow-primary-600/40 hover:-translate-y-0.5',
