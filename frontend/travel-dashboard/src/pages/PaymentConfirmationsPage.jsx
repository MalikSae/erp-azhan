...
import { client, listAllPayments, verifyPayment } from 'shared';
  ...
  return (
    <div className="space-y-5">
      ...
      <section className="rounded-lg border border-neutral-200 bg-white p-4">
        <div className="mb-3 flex items-center justify-between gap-3">
          <div>
            ...
            <p className="text-xs text-neutral-500">Persempit data berdasarkan status, rekening, atau tanggal transfer.</p>
          </div>
          {hasFilters && (
            <button onClick={resetFilters} className="text-sm font-semibold text-brand hover:underline">
              Reset filter
            </button>
          )}
        </div>
      ...
      <DataTable
        ...
        itemsPerPage={10}
        searchPlaceholder="Cari invoice, jamaah, paket, pengirim, atau rekening..."
